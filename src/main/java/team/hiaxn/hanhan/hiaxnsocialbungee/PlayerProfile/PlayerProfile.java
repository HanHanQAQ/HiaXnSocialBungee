...
public class PlayerProfile {
    ...
    private CopyOnWriteArrayList<FriendRequest> friendRequestsList = new CopyOnWriteArrayList<>();
    ...
    public CopyOnWriteArrayList<FriendRequest> getFriendRequestsList() {
        return this.friendRequestsList;
    }
    public void addFriendRequest(FriendRequest request) { this.friendRequestsList.add(request); }
